#!/usr/bin/env python
"""
Treinamento e forecast LightGBM passo a passo (rolling forecast) em pandas.
"""
import logging
...
class LGBMTrainer:
    ...
    def _setup_logging(self):
        ...
        logging.getLogger("pipeline").info("==== INÍCIO LIGHTGBM ====")
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        # gera todas as features de uma vez
    ...
    def rolling_forecast(self, model, df: pd.DataFrame) -> pd.DataFrame:
        ...
        for step in range(1, self.horizon + 1):
            ...
            # prever sempre com as mesmas colunas
            Xf = df_last[self.feature_cols]
            yhat = model.predict(Xf)

            # monta próximo registro
    ...
    def run(self):
        ...
        df_ins['ml_pred'] = model.predict(df[self.feature_cols])
